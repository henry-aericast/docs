...
Click the **Database Connection** button to access your PostgreSQL connection details for use with database clients, ORMs, and other tools.

### Connection String Formats

When you click **Database Connection**, you'll see a modal with connection strings in 9 different formats:
...
If you need to reset your database password (for security reasons or if it was compromised):

1. Go to the **Connection Info** tab
2. Click the **Reset Password** button
3. A new 32-character password is generated automatically
4. All connection strings are updated immediately
5. Your app will need to use the new password

<Warning>
Resetting your password will immediately invalidate the old password. Update your `.env.local` file and redeploy any applications using the old credentials.
</Warning>
...
Edge Functions automatically have access to these additional variables:
...
The `SUPABASE_SERVICE_ROLE_KEY` has full admin access and should never be exposed in frontend code.
